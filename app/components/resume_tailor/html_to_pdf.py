...
def create_pdf_from_html(html_content: str, output_path: Optional[str] = None) -> Union[bytes, str]:
    """
...
def create_pdf_from_html_file(html_file_path: str, output_path: Optional[str] = None) -> Union[bytes, str]:
    """
